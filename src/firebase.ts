...
const firebaseConfig = {
  ...
  // Esse cara DEVE ser o do firebaseapp.com que veio das suas variáveis
  authDomain: import.meta.env.VITE_FIREBASE_AUTH_DOMAIN || firebaseAppletConfig.authDomain || "",
  projectId: import.meta.env.VITE_FIREBASE_PROJECT_ID || (import.meta.env as any).ID_DO_PROJETO_VITE_FIREBASE || firebaseAppletConfig.projectId || "",
  storageBucket: import.meta.env.VITE_FIREBASE_STORAGE_BUCKET || firebaseAppletConfig.storageBucket || "",
  messagingSenderId: import.meta.env.VITE_FIREBASE_MESSAGING_SENDER_ID || firebaseAppletConfig.messagingSenderId || "",
  appId: import.meta.env.VITE_FIREBASE_APP_ID || firebaseAppletConfig.appId || "",
  databaseURL: (import.meta.env as any).URL_DO_BANCO_DE_DADOS_VITE_F || (import.meta.env as any).VITE_FIREBASE_DATABASE_URL || "",
